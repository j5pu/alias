...
: "
# Connect
smbclient //msi/j5pu -U j5pu%${PASSWORD}
smbclient //msi/msi -U j5pu%${PASSWORD}
open smb://j5pu:${PASSWORD}@msi/j5pu
# Mount
mount -t  smbfs -o username=j5pu //msi/Downloads /home/j5pu/Downloads
"
...
compare /etc/samba/smb.conf <<EOF
[homes]
   comment = Home Directories
   browseable = yes
   guest ok = yes
...
#yes "${PASSWORD}" | sudo smbpasswd -a j5pu
