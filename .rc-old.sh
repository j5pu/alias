...
# Generated by /Users/j5pu/rc/bin/rc
...
if ! command -v resh >/dev/null; then
  . "/Users/j5pu/rc/etc/functions.d/rc.sh"
...
if [ "${RC_PROFILE_D_SOURCED}" -eq 0 ]; then
  ...
  export RC_GENERATED_HOSTS_D="/Users/j5pu/rc/generated/hosts.d"
...
export ENV="/Users/j5pu/rc/.rc.sh"
