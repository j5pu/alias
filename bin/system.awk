...
BEGIN {
    ...
    DESC["GIT_CONFIG_SYSTEM"] = "Git config system-level configuration /etc/gitconfig or /usr/local/etc/gitconfig https://git-scm.com/docs/git-config"
    DESC["GIT_DEFAULT_BRANCH"] = "Git default branch from git config to generate template, etc."
    DESC["GIT_TEMPLATE_DIR"] = "Files and directories in the template directory whose name do not start with a dot will be copied to the $GIT_DIR after it is created https://git-scm.com/docs/git-init"
    ...
    DESC["RC_CONFIG_GIT"] = "RC 'config' 'git' directory for: gitconfig, gitignore and hooks"
    DESC["RC_CONFIG_GIT_EXCLUDES"] = "RC 'generated' 'git' 'excludesFile' for git config core.excludesFile"
    DESC["RC_CONFIG_GIT_HOOKS"] = "Git hooks directory used in gitconfig core.hookspath"
    ...
    DESC["RC_GENERATED_GIT"] = "RC 'generated' 'git' for git init template"
    ...
    VALUES["RC_CONFIG_GIT"] = VALUES["RC_CONFIG"]"/git"
    VALUES["RC_CONFIG_GIT_EXCLUDES"] = VALUES["RC_CONFIG_GIT"]"/gitignore"
    VALUES["RC_CONFIG_GIT_HOOKS"] = VALUES["RC_CONFIG_GIT"]"/hooks"
    ...
    VALUES["RC_GENERATED_GIT"] = VALUES["RC_GENERATED"]"/git"
    ...
    VALUES["GIT_CONFIG_SYSTEM"] = VALUES["RC_CONFIG_GIT"]"/gitconfig"
    VALUES["GIT_DEFAULT_BRANCH"] = process("awk -F= '/defaultBranch/ { gsub(\" \", \"\"); print $2 }' "VALUES["GIT_CONFIG_SYSTEM"])
    VALUES["GIT_TEMPLATE_DIR"] = VALUES["RC_GENERATED_GIT"]"/template"
